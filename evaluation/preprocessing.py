...
if __name__ == '__main__':
    ...
    os.makedirs('stochastic_segmentation_networks/assets/BraTS2017_data', exist_ok=True)
    train_index = output_dataframe.loc[train_ids]
    train_index.to_csv('stochastic_segmentation_networks/assets/BraTS2017_data/data_index_train.csv')
    valid_index = output_dataframe.loc[valid_ids]
    valid_index.to_csv('stochastic_segmentation_networks/assets/BraTS2017_data/data_index_valid.csv')
    test_index = output_dataframe.loc[test_ids]
    test_index.to_csv('stochastic_segmentation_networks/assets/BraTS2017_data/data_index_test.csv')
